...
public class FilmOutOfStockListener extends StandardNotificationProvider<Film> implements
    EntityChangedListener<Film> {
  private final UserRepository userRepository;

  @Override
  public Class<? extends EntityChangedEvent<Film>> getEventClass() {
    return FilmOutOfStockEvent.class;
  }
  ...
  public String withMessages(String languageCode) {
    return """
        The film **${newState.title}** is out of stock.
        """;
  }
